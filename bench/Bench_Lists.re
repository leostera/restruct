...
module Make = {
  ...
  let run = size =>
    ReBench.(
      ...
      |> add("Lazy.List.make", make_lazy_list(size))
...
module Take = {
  ...
  let run = size =>
    ReBench.(
      ...
      |> add("Lazy.List.take", take_lazy_list(size))
...
module Drop = {
  ...
  let run = size =>
    ReBench.(
      ...
      |> add("Lazy.List.drop", drop_lazy_list(size))
...
module Reverse = {
  ...
  let run = size =>
    ReBench.(
      ...
      |> add("Lazy.List.reverse", reverse_lazy_list(size))
