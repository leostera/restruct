...
function run(size) {
  ...
  return ReBench.run(/* record */[/* async */false], ReBench.on(/* Complete */2, (function () {
                    console.log("");
                    return /* () */0;
                              ...
                              /* bench */append_strict_list(size)
                                  ...
                                  /* bench */append_lazy_list(size)
                                      ...
                                      /* bench */append_strict_belt_list(size)
                                          ...
                                          /* desc */"Belt.Array.concat",
                                          /* bench */append_belt_array(size)
                                        ], ReBench.add(/* record */[
                                              /* desc */"Array.append",
                                              /* bench */append_array(size)
                                            ], ReBench.make(/* () */0))))))))));
}
  ...
  return ReBench.run(/* record */[/* async */false], ReBench.on(/* Complete */2, (function () {
                    ...
                    return /* () */0;
                            ...
                            return partial_arg(size, "List.take", param);
                              ...
                              /* desc */"ReStruct.Lazy.List.take",
                              /* bench */take_lazy_list(size)
                            ], ReBench.add(/* record */[
                                  /* desc */"Belt.List.take",
                                  /* bench */take_strict_list(size)
                                ], ReBench.add(/* record */[
                                      /* desc */"Belt.Array.slice",
                                      /* bench */take_array(size)
                                    ], ReBench.make(/* () */0))))))));
}
  ...
  return ReBench.run(/* record */[/* async */false], ReBench.on(/* Complete */2, (function () {
                    ...
                    return /* () */0;
                            ...
                            return partial_arg(size, "List.drop", param);
                              ...
                              /* desc */"ReStruct.Lazy.List.drop",
                              /* bench */drop_lazy_list(size)
                            ], ReBench.add(/* record */[
                                  /* desc */"Belt.List.drop",
                                  /* bench */drop_strict_list(size)
                                ], ReBench.add(/* record */[
                                      /* desc */"Belt.Array.sliceToEnd",
                                      /* bench */drop_array(size)
                                    ], ReBench.make(/* () */0))))))));
}
                    ...
                    return /* () */0;
                            ...
                            return partial_arg(size, "List.reverse", param);
                              ...
                              /* bench */reverse_lazy_list(size)
                                  ...
                                  /* desc */"Belt.List.reverse",
                                  /* bench */reverse_strict_list(size)
                                ], ReBench.add(/* record */[
                                      /* desc */"Belt.Array.reverse",
                                      /* bench */reverse_array(size)
                                    ], ReBench.make(/* () */0))))))));
}
