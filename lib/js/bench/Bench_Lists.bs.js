...
function make_lazy_list(x) {
  return ReStruct_Lazy_List$Restruct.make(x, 0);
}
...
function make_lazy_list$1(x, _) {
  ReStruct_Lazy_List$Restruct.make(x, 0);
  return /* () */0;
}
  ...
  return ReBench$Restruct.run({
              async: false
                    ...
                    return /* () */0;
                            ...
                            return Bench_Utils$Restruct.default_announcer(size, "List.Make", param);
                          }), ReBench$Restruct.add("List (inductive)", (function () {
                                make_strict_list(size);
                                return /* () */0;
                              }), ReBench$Restruct.add("ReStruct.Lazy.List.make", (function () {
                                    ReStruct_Lazy_List$Restruct.make(size, 0);
                                    return /* () */0;
                                  }), ReBench$Restruct.add("Belt.List.make", (function () {
                                        Belt_List.make(size, 0);
                                        return /* () */0;
                                      }), ReBench$Restruct.add("Belt.Array.make", (function () {
...
function append_lazy_list(x) {
  var l = ReStruct_Lazy_List$Restruct.make(x, 0);
  var l$prime = ReStruct_Lazy_List$Restruct.make(x, 0);
  return (function () {
  ...
  return ReBench$Restruct.run({
              async: false
                    ...
                    return /* () */0;
                          ...
                          }), ReBench$Restruct.add("List.append", append_strict_list(size), ReBench$Restruct.add("ReStruct.Lazy.List.append", append_lazy_list(size), ReBench$Restruct.add("Belt.List.concat", append_strict_belt_list(size), ReBench$Restruct.add("Belt.Array.concat", append_belt_array(size), ReBench$Restruct.add("Array.append", append_array(size), ReBench$Restruct.make(/* () */0))))))))));
}
...
function take_lazy_list(x) {
  var l = ReStruct_Lazy_List$Restruct.make(x, 0);
  return (function () {
      ReStruct_Lazy_List$Restruct.take(x, l);
      return /* () */0;
    });
}
  ...
  return ReBench$Restruct.run({
              async: false
                    ...
                    return /* () */0;
                            ...
                            return Bench_Utils$Restruct.default_announcer(size, "List.take", param);
                          }), ReBench$Restruct.add("ReStruct.Lazy.List.take", take_lazy_list(size), ReBench$Restruct.add("Belt.List.take", take_strict_list(size), ReBench$Restruct.add("Belt.Array.slice", take_array(size), ReBench$Restruct.make(/* () */0))))))));
}
...
function drop_lazy_list(x) {
  var l = ReStruct_Lazy_List$Restruct.make(x, 0);
  return (function () {
      ReStruct_Lazy_List$Restruct.drop(x, l);
      return /* () */0;
    });
}
  ...
  return ReBench$Restruct.run({
              async: false
                    ...
                    return /* () */0;
                            ...
                            return Bench_Utils$Restruct.default_announcer(size, "List.drop", param);
                          }), ReBench$Restruct.add("ReStruct.Lazy.List.drop", drop_lazy_list(size), ReBench$Restruct.add("Belt.List.drop", drop_strict_list(size), ReBench$Restruct.add("Belt.Array.sliceToEnd", drop_array(size), ReBench$Restruct.make(/* () */0))))))));
}
...
function reverse_lazy_list(x) {
  var l = ReStruct_Lazy_List$Restruct.make(x, 0);
  return (function () {
      ReStruct_Lazy_List$Restruct.reverse(l);
      return /* () */0;
    });
}
  ...
  return ReBench$Restruct.run({
              async: false
                    ...
                    return /* () */0;
                            ...
                            return Bench_Utils$Restruct.default_announcer(size, "List.reverse", param);
                          }), ReBench$Restruct.add("ReStruct.Lazy.List.reverse", reverse_lazy_list(size), ReBench$Restruct.add("Belt.List.reverse", reverse_strict_list(size), ReBench$Restruct.add("Belt.Array.reverse", reverse_array(size), ReBench$Restruct.make(/* () */0))))))));
}
