              ...
              async: false
                    ...
                    return /* () */0;
                            ...
                            return Bench_Utils$Restruct.default_announcer(size, "List.Make", param);
                                ...
                                return /* () */0;
                              }), ReBench$Restruct.add("Lazy.List.make", (function () {
  ...
  return ReBench$Restruct.run({
              async: false
                    ...
                    return /* () */0;
                          ...
                          }), ReBench$Restruct.add("List.append", append_strict_list(size), ReBench$Restruct.add("Lazy.List.append", append_lazy_list(size), ReBench$Restruct.add("Belt.List.concat", append_strict_belt_list(size), ReBench$Restruct.add("Belt.Array.concat", append_belt_array(size), ReBench$Restruct.add("Array.append", append_array(size), ReBench$Restruct.make(/* () */0))))))))));
}
  ...
  return ReBench$Restruct.run({
              async: false
                    ...
                    return /* () */0;
                          ...
                          }), ReBench$Restruct.add("Lazy.List.take", take_lazy_list(size), ReBench$Restruct.add("Belt.List.take", take_strict_list(size), ReBench$Restruct.add("Belt.Array.slice", take_array(size), ReBench$Restruct.make(/* () */0))))))));
}
  ...
  return ReBench$Restruct.run({
              async: false
                    ...
                    return /* () */0;
                          ...
                          }), ReBench$Restruct.add("Lazy.List.drop", drop_lazy_list(size), ReBench$Restruct.add("Belt.List.drop", drop_strict_list(size), ReBench$Restruct.add("Belt.Array.sliceToEnd", drop_array(size), ReBench$Restruct.make(/* () */0))))))));
}
  ...
  return ReBench$Restruct.run({
              async: false
                    ...
                    return /* () */0;
                          ...
                          }), ReBench$Restruct.add("Lazy.List.reverse", reverse_lazy_list(size), ReBench$Restruct.add("Belt.List.reverse", reverse_strict_list(size), ReBench$Restruct.add("Belt.Array.reverse", reverse_array(size), ReBench$Restruct.make(/* () */0))))))));
}
