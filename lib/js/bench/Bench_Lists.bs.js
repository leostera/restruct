  ...
  return ReBench$Restruct.run({
              async: true
                    ...
                    return /* () */0;
                            ...
                            return /* () */0;
                          }), ReBench$Restruct.add("List", (function () {
                                make_strict_list(size);
                                return /* () */0;
                              }), ReBench$Restruct.add("Array.make", (function () {
                                    return /* () */0;
                                  }), ReBench$Restruct.add("Lazy.List", (function () {
                                        make_lazy_list(size);
                                        return /* () */0;
...
function append_lazy_list(x) {
  ...
  return (function () {
      ReStruct_Lazy_List$Restruct.append(Block.__(250, [l]), Block.__(250, [l$prime]));
      return /* () */0;
    });
}
  ...
  return ReBench$Restruct.run({
              async: true
                    ...
                    return /* () */0;
                            ...
                            console.log("Begin Append Benchmark");
                            return /* () */0;
